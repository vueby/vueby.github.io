...
const autometa_options = {
  ...
  canonical_base: 'https://vueby.github.io',
};
...
module.exports = {
  ...
  themeConfig: { // 主题配置
    ...
    footer: { // 页脚信息
      ...
      copyrightInfo: '大白的故事 | <a href="https://github.com/vueby/vueby.github.io/blob/main/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
    }
  },
  plugins: [ // 插件
    ...
    // }],
    ['sitemap', {
      hostname: "https://vueby.github.io",
      // 排除无实际内容的页面
      exclude: ["/404.html"]
    }],
    [
      ...
      {
        baseURL: 'https://vueby.github.io', // base url for your canonical link, optional, default: ''
    ...
    ['thirdparty-search', { // 可以添加第三方搜索链接的搜索框（原官方搜索框的参数仍可用）
      thirdparty: [ // 可选，默认 []
        ...
        {
          title: '通过百度搜索本站的',
          frontUrl: 'https://www.baidu.com/s?wd=site%3Avueby.github.io%20'
        }
      ]
    }],
    ...
    [
      ...
      // },
      {
        ...
        options: {
          ...
          repo: 'vueby.github.io', // GitHub 仓库
